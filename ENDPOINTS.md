...
| [`google-search`](https://x402.agentutility.ai/google-search) | $0.01 | Ranked Google organic results for any query — title, URL, snippet, domain, and an optional recency filter, via Decodo Google Search. |
...
| [`llm-cost-estimate`](https://x402.agentutility.ai/llm-cost-estimate) | $0.005 | LLM cost estimate API and token cost calculator for comparing inference cost across models before you run a prompt. |
