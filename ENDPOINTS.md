...
| [`browser-session`](https://x402.agentutility.ai/browser-session) | $0.03 | Loads a public URL in a real headless browser with JavaScript executed, then returns the rendered HTML and page title, or a base64 screenshot. |
...
| [`content-authenticity-report`](https://x402.agentutility.ai/content-authenticity-report) | $0.06 | Check whether a page is AI-generated slop before your agent cites or acts on it. |
...
| [`image-generate`](https://x402.agentutility.ai/image-generate) | $0.01 | Generate an SFW hosted PNG from a text prompt for a repeatable image-production step. |
...
| [`slop-filtered-brief`](https://x402.agentutility.ai/slop-filtered-brief) | $0.06 | Research a topic without AI-generated slop. |
